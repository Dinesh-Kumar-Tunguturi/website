...
const AboutUs = () => {
    return (
        <section className="about-section">
            <div className="container about-container" style={{ flexDirection: 'column', alignItems: 'center' }}>
                <div className="about-badge" style={{ marginBottom: '40px' }}>ABOUT US</div>
                ...
                <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center', gap: '60px', width: '100%' }}>
                    ...
                    <div className="about-visuals" style={{ flex: '1 1 400px' }}>
                        <div className="image-stack" style={{ margin: '0 auto' }}>
                            <motion.div
                    ...
                    {/* Right Side: Content */}
                    <div className="about-content" style={{ flex: '1 1 500px', textAlign: 'left', alignItems: 'flex-start' }}>
                        <h2 style={{ textAlign: 'left' }}>Empowering Careers Through Personalized, Inclusive Job Applications</h2>
                        ...
                        <ul className="about-list" style={{ textAlign: 'left' }}>
