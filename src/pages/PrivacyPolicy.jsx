            ...
            <div className="container" style={{ padding: '120px 6vw', minHeight: '80vh', maxWidth: '800px', margin: '0 auto' }}>
                ...
                <div className="policy-content" style={{ color: '#444', lineHeight: '1.8' }}>
                    <section style={{ marginBottom: '32px' }}>
                        <h2 style={{ fontSize: '1.5rem', color: '#111', marginBottom: '16px' }}>1. Data Collection</h2>
                    ...
                    <section style={{ marginBottom: '32px' }}>
                        <h2 style={{ fontSize: '1.5rem', color: '#111', marginBottom: '16px' }}>2. How We Use Data</h2>
                    ...
                    <section style={{ marginBottom: '32px' }}>
                        <h2 style={{ fontSize: '1.5rem', color: '#111', marginBottom: '16px' }}>3. Data Security</h2>
