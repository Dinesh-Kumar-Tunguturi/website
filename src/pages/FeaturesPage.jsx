        ...
        <div className="features-page">
            ...
            <div className="container page-container">
                ...
                <div className="features-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '30px' }}>
                    <div className="feature-item" style={{ background: 'white', padding: '30px', borderRadius: '30px', boxShadow: '0 20px 40px rgba(0,0,0,0.05)' }}>
                        <h3 style={{ fontSize: '1.3rem', marginBottom: '16px' }}>🚀 Automated Applications</h3>
                    ...
                    <div className="feature-item" style={{ background: 'white', padding: '30px', borderRadius: '30px', boxShadow: '0 20px 40px rgba(0,0,0,0.05)' }}>
                        <h3 style={{ fontSize: '1.3rem', marginBottom: '16px' }}>📝 Resume Tailoring</h3>
                    ...
                    <div className="feature-item" style={{ background: 'white', padding: '30px', borderRadius: '30px', boxShadow: '0 20px 40px rgba(0,0,0,0.05)' }}>
                        <h3 style={{ fontSize: '1.3rem', marginBottom: '16px' }}>📊 Real-time Dashboard</h3>
